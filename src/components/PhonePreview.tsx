  ...
  return (
    <div className="relative">
      ...
      <div className="relative w-[280px] h-[560px] bg-gradient-to-b from-zinc-800 to-zinc-900 rounded-[3rem] p-3 shadow-2xl">
        ...
        {/* Screen */}
        <div className="w-full h-full bg-gradient-to-br from-slate-950 via-[#1a0b2e] to-black rounded-[2.4rem] overflow-hidden relative">
          {/* Mini aurora */}
          ...
          <div className="relative h-full overflow-y-auto p-4 pt-10 scrollbar-none">
            ...
            <div className="flex flex-col items-center mb-4">
              ...
              <h3 className="mt-2 text-sm font-bold text-foreground text-center">
